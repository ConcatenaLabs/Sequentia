...
public:
    explicit CSequentiaParams(const ArgsManager& args) {
        ...
        // SEQUENTIA: all Bitcoin soft forks are buried-active from genesis on
        // this fresh height-1 chain (CRITICAL: CSV/BIP112 must be active or the
        // staking-output unbonding lock is unenforceable — nothing-at-stake).
        // These were inherited from Bitcoin mainnet's historical heights and
        // MUST be 0/1 here, matching every other Sequentia network.
...
public:
    explicit CTestNetParams(const ArgsManager& args) {
        ...
        //
        // 101,810 is a day past the tip (100,364 at 2026-08-19T18:19Z),
