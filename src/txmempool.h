...
public:
    ...
    //! SEQUENTIA: the modified fee is denominated in reference fee atoms
    //! (nFeeValue plus any PrioritiseTransaction deltas), so transactions
    //! paying fees in different assets stay comparable.
    ...
    // Updates the modified fees (in reference fee atoms) with descendants/ancestors.
