...
BOOST_AUTO_TEST_CASE(naive_blinding_test)
{
...

    {
        ...
        BOOST_CHECK(VerifyAmounts(inputs, CTransaction(tx3), nullptr, nullptr, false));
...

    {
        ...
        BOOST_CHECK(!VerifyAmounts(inputs, CTransaction(tx4), nullptr, nullptr, false)); // Spends a blinded coin with no blinded outputs to compensate.
...

    {
        ...
        // This one broken
        BOOST_CHECK(VerifyAmounts(inputs, CTransaction(tx4), nullptr, nullptr, false));
    ...
    }
    {
        ...
        BOOST_CHECK(!VerifyAmounts(inputs, CTransaction(tx5), nullptr, nullptr, false));
        ...
        BOOST_CHECK(!VerifyAmounts(inputs, CTransaction(txtemp), nullptr, nullptr, false));
