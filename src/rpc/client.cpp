...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "sendbtctoaddress", 1, "amount" },
    { "sendbtctoaddress", 2, "fee_rate" },
    { "sendbtctoaddress", 3, "subtractfeefromamount" },
    { "sendbtctoaddress", 4, "estimate_only" },
    { "listbtctransactions", 0, "scan" },
    ...
    { "getstakescript", 5, "liquid_locktime"},
    { "registerstake", 1, "amount"},
    ...
    { "setrewardautoconvert", 0, "enabled"},
    { "setrewardautoconvert", 2, "min_receive"},
    { "setrewardautoconvert", 3, "max_slippage_bp"},
    { "setrewardautoconvert", 4, "exclude"},
    { "convertrewards", 0, "dry_run"},
    ...
    { "musigpartialsign", 3, "pubnonces"},
    { "musigaggregate", 0, "pubkeys"},
    { "musigaggregate", 1, "pubnonces"},
    { "musigaggregate", 2, "partialsigs"},
    { "musigverify", 0, "pubkeys"},
    //
    // ELEMENTS:
