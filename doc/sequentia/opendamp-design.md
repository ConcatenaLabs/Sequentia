...
**On the live testnet the wider budget starts at height 101,810**, a little over
...
Until 101,810 the new binary enforces the old budget, so upgrading early is safe
