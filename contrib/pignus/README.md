...
Design and security analysis: [`doc/sequentia/pignus-design.md`](../../doc/sequentia/pignus-design.md).
...
```
contrib/pignus/tests/cli_drill.sh        # offline, no node, ~2 seconds
...
test/functional/feature_pignus_platform.py   this library, end to end
contrib/pignus/tests/cli_drill.sh            the commands, offline
```

Both functional tests are in `test_runner.py`.
